...
turtles-own [status eating_time waiting_time choice found_table table]
 ...
 ask turtles [
    ...
    (ifelse
      ...
      status = "waiting" [
        ...
        ifelse waiting_time > 0 [set status " finding" ][print "ako ay umalis kasi antagal >:( " set status "exit_door"]
      ]
      status = "sitting"[
